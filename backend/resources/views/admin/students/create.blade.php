...
@section('title', 'Register a student')
...
@section('content')
  <div class="container">
    @if(session('student-added'))
      <div class="alert alert-primary alert-dismissble fade show mt-3" role="alert">
        ...
        <strong>  Success!</strong>{{ session('student-added') }}
      </div>
    @endif
  </div>
  ...
  <div class="row justify-content-center mt-5">
    <div class="col-8">
      <form action="{{ route('admin.students.store') }}" class="bg-white shadow rounded-3 p-5" method="post" enctype="multipart/form-data">
      @csrf
        
        <h2 class="h3 mb-3 fw-light text-muted">Create a student</h2>
        <div class="row mb-3">
